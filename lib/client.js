...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
       ...
       * The typed Remote signature is `commands.execute(agentId, line,
       * submittedAttachments)` — an untagged client context (this plugin) is
       * NOT projected onto the agent scope, so all three business arguments are
       * required and omitting the attachment list is rejected client-side.
       */
